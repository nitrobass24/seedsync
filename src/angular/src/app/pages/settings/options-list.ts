  ...
  options: [
    {
      ...
      description:
        'How many items download in parallel.\n' + '(cmd:queue-parallel)',
    },
    {
      type: OptionType.Text,
    ...
    },
    {
      ...
      description:
        'Number of connections for single-file download.\n' +
        '(pget:default-n)',
    },
    {
      type: OptionType.Text,
      ...
      description:
        'Number of per-file connections for directory download.\n' +
        '(mirror:use-pget-n)',
    },
    {
      type: OptionType.Text,
      ...
      description:
        'Maximum number of files to fetch in parallel for single directory download.\n' +
    ...
    },
    {
      ...
      description:
        'Download speed limit. Supports suffixes: K, M (e.g. 500K, 2M). ' +
