...
So -p 8800:80 would expose port 80 from inside the container to be accessible from the host's IP on port 8800
http://192.168.x.x:8800 would show you what's running INSIDE the container on port 80.`


* `-p 8800` - the port seedsync webinterface
